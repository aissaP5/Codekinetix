...
export default function TopBar() {
  ...
  return (
    <>
      <header className="relative z-40 border-b border-bone/10 bg-void">
        <div className="max-w-[1760px] mx-auto flex items-center justify-between gap-3 px-4 sm:px-8 md:px-10 lg:px-16 xl:px-20 py-3.5 sm:py-4">
          {/* Wordmark */}
          <Link
            href="/"
